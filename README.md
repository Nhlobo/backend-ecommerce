...
This is the backend API server for the Premium Hair e-commerce platform. It provides REST API endpoints for the admin dashboard and customer-facing frontend.
...
Update the admin dashboard configuration (`admin-ecommerce/js/config.js`):
...
## 🖥️ Admin Dashboard (Static App)

A deployable admin static app scaffold is included at `admin-ecommerce/`.
...
The admin app reads runtime API config from `/config.js`, generated by `admin-ecommerce/server.js`.
